        ...
        <ul>
          <li>
            <dl>
              <dt>Home Page</dt>
              <dd>
                Contain 3 sections for sample of crypto coins, sample of news
                ,and trending coins
              </dd>
            </dl>
          </li>
          ...
          <li>
            <dl>
              <dt>Crypto currencies Page</dt>
              <dd> Provide list of Crypto currencies </dd>
            </dl>
          </li>
          <li>
            <dl>
              <dt>Crypto details Page</dt>
        ...
        <ul>
          <li>
            <dl>
              <dt>Home page</dt>
              <dd>
                The landing page , It contains several section one of to to show
                sample of the project , counter to provid the numbers of the
                clients , and about us section it contains a CTA
              </dd>
            </dl>
          </li>
          <li>
            <dl>
              <dt>Products Page</dt>
              <dd>
                it contain whole course but showing 6 per page and 2 buttons to
                do pagination between every project
              </dd>
            </dl>
          </li>
          <li>
            <dl>
              <dt>Terms Page</dt>
              <dd>
                some text about website terms and every part of terms in a
                collapsed menu
              </dd>
            </dl>
          </li>
          <li>
            <dl>
              ...
              <dd>
                {" "}
                Contain form with 2 input fields , button to submit and Link to
                sign up page if the user did not have an account .. ,the two
                inputs one for email, and one for passowrd tracked by state to
                get what user write in throught onChange event , the submit
                button send the input field data to method created by Context
                Api to send it to firebase{" "}
              </dd>
            </dl>
          </li>
          <li>
            <dl>
              ...
              <dd>
                {" "}
                Contain form with 2 input fields , button to submit and Link to
                sign in page if the user did have an account .. ,the two inputs
                one for email, and one for passowrd tracked by state to get what
                user write in throught onChange event , the submit button send
                the input field data to method created by Context Api to send it
                to firebase{" "}
              </dd>
            </dl>
          </li>
          <li>
            <dl>
              ...
              <dd>
                this page is a protect route to enter it , the user have to log
                in first{" "}
              </dd>
            </dl>
          </li>
          <li>
            <dl>
              ...
              <dd>
                {" "}
                Protect route page the user have to log in first to be seen on
                the navbar ,it conatin the user list of the courser he on or the
                list of the following list which the not availbe for now{" "}
              </dd>
            </dl>
          </li>
        </ul>{" "}
        ...
        <ul>
          <li>
            <dl>
              <dt>Home</dt>
              <dd>
                Conatin navbar with logo and search input feild , side bar which
                contain several searchterms{" "}
              </dd>
            </dl>
          </li>
          <li>
            <dl>
              <dt>Vedio Page</dt>
              <dd>
                open the video page which provide a box for vedio and sidebase
                for suggestion list{" "}
              </dd>
            </dl>
          </li>
